...
def EmpRegister():
    ...
    #Employee Paswword
    lb3 = Label(labelFrame,text="Key : ", bg='#044F67', fg='white')
    ...
    lb5 = Label(labelFrame,text="CheckIn : ", bg='#044F67', fg='white')
...
def Login():
    ...
    # Login ID
    lb1 = Label(labelFrame,text="Email : ", bg='#044F67', fg='white')
    ...
    # Paswword
    lb3 = Label(labelFrame,text="Queries : ", bg='#044F67', fg='white')
    ...
    # Role
    lb4 = Label(labelFrame,text="Check/O time : ", bg='#044F67', fg='white')
...
def studentRegister():
    ...
    en4.place(relx=0.3,rely=0.5, relwidth=0.62)
     ...
     # Student Semester
    lb5 = Label(labelFrame,text="Visiting : ", bg='#044F67', fg='white')
    lb5.place(relx=0.05,rely=0.65)
    ...
    # Student Batch
    lb6 = Label(labelFrame,text="CheckIn Time : ", bg='#044F67', fg='white')
...
def Employee():
    ...
    btn1 = Button(root,text="Check In",bg='black', fg='white',command=EmpRegister)
    btn1.place(relx=0.28,rely=0.3, relwidth=0.2,relheight=0.1)

    btn2 = Button(root,text="Check Out",bg='black', fg='white', command=Login)
...
def Student():
    ...
    btn1 = Button(root,text="Check In",bg='black', fg='white', command=studentRegister)
    btn1.place(relx=0.28,rely=0.3, relwidth=0.2,relheight=0.1)
...
background_image =Image.open("innoback.jpg")
...
headingLabel = Label(headingFrame2, text="INNOVACER ENTRY BOOK", fg='black')
...
btn2 = Button(root,text="Visitor",bg='black', fg='white', command=Student)
